...
amp_down.colspan = 1
g_fit.add(fit_min, fit_max, flow_autofit, act1, peak_pos, peak_fix, peak_up, peak_down, \
          FWHM, fwhm_fix, fwhm_up, fwhm_down, amp, amp_fix, amp_up, amp_down)
